...
dialogB.cont.add(kills).size(Core.graphics.getWidth()/4, Core.graphics.getHeight()/10.5)
dialogB.cont.row()

let built = addTab(builtCount + gameStats.buildingsBuilt)

dialogB.cont.add(built).size(Core.graphics.getWidth()/4, Core.graphics.getHeight()/10.5)
dialogB.cont.row()

let wavel = addTab(wavesLasted + gameStats.wavesLasted)

dialogB.cont.add(wavel).size(Core.graphics.getWidth()/4, Core.graphics.getHeight()/10.5)
dialogB.cont.row()
